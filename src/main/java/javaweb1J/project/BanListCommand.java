...
public class BanListCommand implements ProjectInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int trc= dao.getBanTotalRecordCount(idx);
		...
		ArrayList<MemberVO> vos = dao.getBanList(idx ,stIndexNo,pageSize );
